...
function ExploreCourses() {
    ...
    return (
        <div className='w-[100vw] min-h-[80vh] lg:h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-4 px-[10px] bg-gradient-to-r from-black via-gray-900 to-black text-white'>

            <div className='w-[100%] lg:w-[530px] lg:h-[100%] h-[400px]  flex flex-col items-start justify-center gap-1 md:px-[40px]  px-[20px]'>
